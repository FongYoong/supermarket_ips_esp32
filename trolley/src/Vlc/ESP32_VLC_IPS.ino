...
void DistEst(double RSS1, double RSS2, double RSS3, double RSS4, double *D1, double *D2, double *D3, double *D4){s
  /*Distance Estimation variables*/
  double height = 3; // LED height in meter (m)
  double PD_Area = 0.0000052441; //5.2441mm2 (PD effective area in mm2)
  ...
  double Duty_cycle = 12/15; //0.75%
  double P_TX = 3.3*(1-Duty_cycle); //transmitted power
